...
class Ui_QOpenVPNSettings(object):
    def setupUi(self, QOpenVPNSettings):
        ...
        self.warningCheckBox.setStyleSheet('margin-top: 10px;')
        ...
        # QOpenVPNSettings.setTabOrder(self.sudoCheckBox, self.sudoCommandComboBox)
    ...
    def retranslateUi(self, QOpenVPNSettings):
        ...
        self.warningCheckBox.setText(_translate("QOpenVPNSettings", "Notify if disconnected"))
        self.showlogCheckBox.setText(_translate("QOpenVPNSettings", "View log while connecting"))
